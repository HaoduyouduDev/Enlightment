...
import com.scrat.app.richtext.listener.OnSelectionChangedListener;
...
public class RichEditText extends AppCompatEditText implements TextWatcher {
    ...
    private OnSelectionChangedListener mListener2;
...
//                .fitCenter()
                ...
                .into(new SimpleTarget<Bitmap>() {
                    ...
                    public void onResourceReady(
                        ...
                        Log.d("RichEditText", "width = " + maxWidth);
                        Log.d("RichEditText", "real width = " + bitmap.getWidth());
                        image(path, bitmap);
                    }
                });
    }
...
//        int width = getMeasuredWidth() - getPaddingLeft() - getPaddingRight();
    ...
    public void image(String path, Bitmap pic) {
        ...
        MyImgSpan span = new MyImgSpan(getContext(), pic, path);
        ...
        post(
                new Runnable() {
                    ...
                    public void run() {
                        ...
                        builder.append(HtmlParser.fromHtml(source, new GlideImageGeter(RichEditText.this, glideRequests)));
    ...
    // michael zhan edit
    public void setCanEdit(Boolean arg) {
        canEdit = arg;
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        ...
        if (!canEdit) {
            ...
            Log.d("RichEditText", "Action = " + event.getAction());
            ...
            if (action == MotionEvent.ACTION_UP ||
                ...
                ImageSpan[] imageSpans = getEditableText().getSpans(off, off, ImageSpan.class);
                Log.d("RichEidtText", "size = " + imageSpans.length);

                if (imageSpans.length != 0) {
                    if (action == MotionEvent.ACTION_UP) {
                        Log.d("RichEditText", "Click");
                        if (mListener != null) {
                            mListener.onClick(imageSpans[0].getSource());
                        }
                    }
    ...
    public void setOnImageClickListener(@NonNull OnImageClickListener listener) {
        mListener = listener;
    }

    public void setOnSelectionChangedListener(@NonNull OnSelectionChangedListener listener) {
        mListener2 = listener;
    }
    ...
    protected void onSelectionChanged(int selStart, int selEnd) {
        ...
        if (mListener2 != null) {
            mListener2.onChange(selStart, selEnd);
        }
    }

    // fuck !!! fuck !!!! fuck you beach Touch Event 害得我折磨了一天呐
}
